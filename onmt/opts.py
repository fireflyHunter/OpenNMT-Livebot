...
def model_opts(parser):
    ...
    group.add('--encoder_type', '-encoder_type', type=str, default='livebot',
              choices=['rnn', 'brnn', 'mean', 'transformer', 'cnn', 'livebot'],
              help="Type of encoder layer to use. Non-RNN layers "
                   "are experimental. Options are "
                   "[rnn|brnn|mean|transformer|cnn].")
    group.add('--decoder_type', '-decoder_type', type=str, default='transformer',
              choices=['rnn', 'transformer', 'cnn', 'livebot'],
              help="Type of decoder layer to use. Non-RNN layers "
                   "are experimental. Options are "
                   "[rnn|transformer|cnn].")

    group.add('--layers', '-layers', type=int, default=6,
...
def train_opts(parser):
    ...
    group.add('--vocab_path', '-vocab_path', type=str, default=None,
              help='path of vocab file')
    group.add('--train_source', '-train_source', type=str, default=None,
              help='path of train file')
    group.add('--test_source', '-test_source', type=str, default=None,
              help='path of test set')

    group.add('--visual_path', '-visual_path', type=str, default=None,
              help='path of visual file')
    ...
    group.add('--save_model', '-save_model', default='./ckpt/model',
              help="Model filename (the model will be saved as "
                   "<save_model>_N.pt where N is the number "
                   "of steps")
    group.add('--n_img', '-n_img',
              type=int, default=5,
              help="""number of frames used at testing stage""")
    group.add('--n_com', '-n_com',
              type=int, default=5,
              help="""number of frames used at testing stage""")
    ...
    group.add('--train_steps', '-train_steps', type=int, default=300000,
